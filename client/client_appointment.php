...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function populateDoctors(selectId) {
            fetch('../api/client/appointment_management/get_doctors.php')
        ...
        appointmentDate.addEventListener("change", function() {
            ...
            if (selectedDate) {
                fetch(`../api/client/appointment_management/get_available_slots.php?date=${selectedDate}`)
                    .then(response => response.json())
                    .then(data => {
        ...
        addAppointmentForm.addEventListener("submit", function(event) {
            ...
            fetch("../api/client/appointment_management/add_appointment.php", { // Adjust API path accordingly
                    method: "POST",
                    headers: {
...
async function fetchAppointments(filters = {}) {
    try {
        ...
        let response = await fetch(`../api/client/appointment_management/list_appointments.php?${queryParams}`);
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        document.getElementById("rescheduleAppointmentForm").addEventListener("submit", function(event) {
            ...
            fetch("../api/client/appointment_management/reschedule_appointment.php", {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json",
                    },
